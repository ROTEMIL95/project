...
**קבצים רלוונטיים:** [`PricebookSettings.jsx:184-186`](Frontend/src/pages/PricebookSettings.jsx#L184-L186)

**התגלה שכבר תוקן:**
- ✅ הקוד כבר מכיל redirect אוטומטי לדף הבית
- ✅ הודעת הצלחה מוצגת עם toast
- ✅ delay של שנייה אחת לפני redirect
...
**מיקום:** דיאלוג ריצוף
**קבצים שתוקנו:** [`TilingManualItemDialog.jsx`](Frontend/src/components/quotes/QuoteBuilder/TilingManualItemDialog.jsx)

**הפתרון שיושם:**
- ✅ הוספת כפתור X בפינה ימנית עליונה של הדיאלוג
- ✅ סימון ברור של שדה חובה יחיד "שם הפריט" עם כוכבית אדומה
- ✅ הוספת הסבר "* שדה חובה - יש למלא" בתחתית הטופס
- ✅ שיפור UX עם accessibility (sr-only text)
...
**מיקום:** דף ראשי (Dashboard) - פעולות נוספות
**קבצים שתוקנו:** [`Dashboard.jsx`](Frontend/src/pages/Dashboard.jsx)

**הפתרון שיושם:**
- ✅ הוספת Badge צהוב עם הטקסט "בקרוב" בפינה ימנית עליונה
- ✅ disabled state לכפתורים (opacity מופחת, cursor:not-allowed)
- ✅ ביטול ניווט לעמודים בלחיצה על כפתורים עם `comingSoon: true`
- ✅ הוספת כפתור חדש "הזמנת חומרים" עם אייקון Package
- ✅ הסרת חיצים ופסים תחתונים מכפתורים שנועלו
...
| 🟠 גבוה | 8 | 33% | 2 תוקנו, 6 ממתינים |
| 🟡 בינוני | 12 | 50% | 3 תוקנו, 9 ממתינים |
| **סה"כ** | **24** | **100%** | **6 תוקנו, 18 נותרו** |
