        ...
        <CardHeader className="bg-gray-50/60 border-b space-y-3 sm:space-y-4 p-3 sm:p-4 md:p-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="p-1.5 sm:p-2 bg-yellow-100 rounded-lg">
              <Lightbulb className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-700" />
            </div>
            <div>
              <CardTitle className="text-base sm:text-lg md:text-xl font-semibold text-gray-800">חשמל</CardTitle>
              <CardDescription className="text-xs sm:text-sm text-gray-600">
                <span className="hidden sm:inline">בחר תאריכים לקטגוריה, סנן לפי תת־קטגוריה, הוסף פריטים מנוהלים מהמחירון שלך.</span>
                <span className="sm:hidden">הוסף פריטי חשמל מהמחירון.</span>
              </CardDescription>
            </div>
          </div>
          ...
          <div className="mt-6 relative rounded-2xl border-2 border-indigo-200/70 bg-white/95 p-5 shadow-sm border-r-4 border-r-indigo-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
              <div className="bg-red-50 border border-red-100 rounded-lg p-2 sm:p-3 text-center">
                ...
                <div className="text-base sm:text-lg md:text-xl font-bold text-red-900">{formatNis(summary.cost)}</div>
              </div>
              <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-2 sm:p-3 text-center">
                ...
                <div className="text-base sm:text-lg md:text-xl font-bold text-indigo-700">{formatNis(summary.price)}</div>
              </div>
              <div className="bg-green-50 border border-green-100 rounded-lg p-2 sm:p-3 text-center">
                ...
                <div className="text-base sm:text-lg md:text-xl font-bold text-green-700">{formatNis(summary.profit)}</div>
              </div>
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-2 sm:p-3 text-center">
                <div className="text-[10px] sm:text-[11px] text-gray-700">
                  <span className="hidden sm:inline">סה״כ פריטים בקטגוריה</span>
                  <span className="sm:hidden">פריטים</span>
                </div>
                <div className="text-base sm:text-lg md:text-xl font-bold text-gray-800">{itemsCount}</div>
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <div className="border-t p-3 sm:p-4 bg-gray-50/50">
          <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-2 sm:gap-3">
            ...
            <Button
              ...
              className="text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white w-full sm:w-auto"
            >
              ...
              <span className="md:hidden">
                {(() => {
                  const currentIndex = categoriesNav.findIndex(c => c.id === currentCategoryId);
                  if (currentIndex < categoriesNav.length - 1) {
                    return categoriesNav[currentIndex + 1].name;
                  } else {
